  ...
  return (
    <div className="p-4">
      ...
      <form onSubmit={savePlace}>
        ...
        <button className="mx-auto my-4 flex rounded-full justify-center items-center bg-green-500 text-white my-4 p-2 w-[10%] rounded-md text-xl font-semibold text-white">
          Save
        </button>
      </form>
    </div>
